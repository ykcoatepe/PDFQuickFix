...
class MockBookmarking: Bookmarking {
    ...
    func bookmarkData(for url: URL, includingResourceValuesForKeys _: Set<URLResourceKey>?, relativeTo _: URL?) throws -> Data {
    ...
    func resolveBookmarkData(_ data: Data, options _: URL.BookmarkResolutionOptions, relativeTo _: URL?) throws -> (url: URL, isStale: Bool) {
