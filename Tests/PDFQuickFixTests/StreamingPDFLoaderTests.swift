...
final class StreamingPDFLoaderTests: XCTestCase {
    ...
    func testRenderThumbnail() throws {
        ...
        XCTAssertGreaterThan(try XCTUnwrap(thumbnail?.width), 0)
        XCTAssertGreaterThan(try XCTUnwrap(thumbnail?.height), 0)
    }
    ...
    func testPageSize() throws {
        ...
        XCTAssertGreaterThan(try XCTUnwrap(size?.width), 0)
        XCTAssertGreaterThan(try XCTUnwrap(size?.height), 0)
    }
